...
export default {
    ...
    fetchMystery: `/discover/movie?api_key=${MOVIE_API_KEY}&with_genres=9648`,
    fetchSciFi: `/discover/movie?api_key=${MOVIE_API_KEY}&with_genres=878`,
    fetchWestern: `/discover/movie?api_key=${MOVIE_API_KEY}&with_genres=37`,
    fetchAnimation: `/discover/movie?api_key=${MOVIE_API_KEY}&with_genres=16`,
    fetchTV: `/discover/movie?api_key=${MOVIE_API_KEY}&with_genres=10770`,
};
